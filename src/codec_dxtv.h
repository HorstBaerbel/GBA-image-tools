...
public:
    ...
    static auto encodeDXTV(const std::vector<uint16_t> &image, const std::vector<uint16_t> &prevImage, uint32_t width, uint32_t height, bool keyFrame, double maxBlockError) -> std::pair<std::vector<uint8_t>, std::vector<uint16_t>>;
