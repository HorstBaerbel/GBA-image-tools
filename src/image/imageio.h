...
namespace IO
{
    ...
    {
    public:
        /// @brief Read image from disk and return as sRGB XRGB8888 color data
        /// @note Does NOT set the index or file name part of Data
        /// @param filePath Path to image file
        static auto readImage(const std::string &filePath) -> Image::Frame;

        /// @brief Write sRGB image data to PNG image file
        /// @param image sRGB image data to write. If image.fileName is filled it can be used as the file name
        ...
        /// @brief Write sRGB image data to PNG image files
        /// @param images sRGB images data to write. image.fileName must be filled
        ...
        /// @brief Write raw sRGB image data to file
        /// @param image sRGB image data to write. If image.fileName is filled it can be used as the file name
