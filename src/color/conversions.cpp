...
namespace Color
{
    ...
    constexpr float WHITEPOINT_D50_X = 0.964212;
    ...
    auto LABINVF(float v) -> float
    {
        ...
        return v > CBRT_EPSILON ? v * v * v : (v * 116.0 - 16.0) / KAPPA;
    }
    ...
    auto LABF(float v) -> float
    {
        ...
        constexpr float KAPPA = 24389.0 / 27.0;
        return v > EPSILON ? std::pow(v, THIRD) : (KAPPA * v + 16.0) / 116.0;
    }
