...
auto buildUniqueTileMap(const std::vector<Color::XRGB8888> &src, uint32_t width, uint32_t height, bool detectFlips, uint32_t tileWidth = 8, uint32_t tileHeight = 8) -> std::pair<std::vector<uint16_t>, std::vector<Color::XRGB8888>>;
