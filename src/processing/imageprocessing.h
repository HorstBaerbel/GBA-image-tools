...
namespace Image
{
    ...
    public:
        ...
        Data processStream(const Data &data, Statistics::Container::SPtr statistics = nullptr);
        ...
        static Data toBlackWhite(const Data &data, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        /// @return Returns data as Paletted8
        static Data toPaletted(const Data &data, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        ///                   Target number of colors in palette as uint32_t. This is an upper bound, the palette may be smaller.
        /// @return Returns data as Paletted8
        static std::vector<Data> toCommonPalette(const std::vector<Data> &data, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        static Data toTruecolor(const Data &data, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        static Data toUniqueTileMap(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);

        /// @brief Cut data to 8 x 8 pixel wide tiles and store per tile instead of per scanline.
        /// Width and height of image MUST be a multiple of 8!
        /// @param parameters Unused
        static Data toTiles(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        static Data toSprites(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);

        /// @brief Add color at palette index #0, shifting all other color indices +1
        /// @param parameters Color to add as Color::XRGB8888
        static Data addColor0(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        static Data moveColor0(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        /// @param parameters Unused
        static Data reorderColors(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);

        /// @brief Increate image palette indices by a value
        /// @param parameters Shift value to add to index as uint32_t
        static Data shiftIndices(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);

        /// @brief Convert image index data to 1-,2- or 4-bit values
        /// @param parameters Unused
        static Data pruneIndices(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);

        /// @brief Convert image data to 8-bit deltas
        /// @param parameters Unused
        static Data toDelta8(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);

        /// @brief Convert image data to 16-bit deltas
        /// @param parameters Unused
        static Data toDelta16(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        static Data compressLZ10(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);

        /// @brief Compress image data using RLE
        /// @param parameters:
        /// - Flag for VRAM-compatible compression as bool. Pass true to turn on
        static Data compressRLE(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);

        /// @brief Encode a truecolor RGB888 or RGB555 image as DXT1-ish image with RGB555 pixels
        /// @param parameters: Unused
        static Data compressDXT(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        /// @param state Previous image as Data
        static Data compressGVID(const Data &image, const std::vector<Parameter> &parameters, std::vector<uint8_t> &state, Statistics::Frame::SPtr statistics);
        ...
        static Data convertPixelsToRaw(const Data &data, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        static Data padPixelData(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        static Data convertColorMapToRaw(const Data &data, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        static Data padMapData(const Data &data, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        static Data padColorMap(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);
        ...
        static Data padColorMapData(const Data &image, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);

        /// @brief Fill up all color maps with 0s to the size of the biggest color map
        static std::vector<Data> equalizeColorMaps(const std::vector<Data> &images, const std::vector<Parameter> &parameters, Statistics::Frame::SPtr statistics);

        /// @brief Calcuate pixel-difference to previous image
        /// @param parameters Unused
        /// @param state Previous image as Data
        static Data pixelDiff(const Data &image, const std::vector<Parameter> &parameters, std::vector<uint8_t> &state, Statistics::Frame::SPtr statistics);
    ...
    private:
        ...
        using ConvertFunc = std::function<Data(const Data &, const std::vector<Parameter> &, Statistics::Frame::SPtr statistics)>;
        using ConvertStateFunc = std::function<Data(const Data &, const std::vector<Parameter> &, std::vector<uint8_t> &, Statistics::Frame::SPtr statistics)>;
        using BatchConvertFunc = std::function<std::vector<Data>(const std::vector<Data> &, const std::vector<Parameter> &, Statistics::Frame::SPtr statistics)>;
        using ReduceFunc = std::function<Data(const std::vector<Data> &, const std::vector<Parameter> &, Statistics::Frame::SPtr statistics)>;
