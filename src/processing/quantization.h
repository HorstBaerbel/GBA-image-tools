...
namespace Image
{
    ...
    namespace Quantization
    {
        ...
        /// @return Returns pixel data quantized and converted to Color::Format::Paletted1
        ...
        /// @return Returns pixel data quantized and converted to Color::Format::Paletted1, Paletted2, Paletted4 or Paletted8
