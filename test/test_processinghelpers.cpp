...
template <typename T>
constexpr auto createData(std::vector<T> &&pixelData, MapData &&mapData) -> Data
{
    return {0, "", DataType(), {{0, 0}, Color::Format::Unknown, Color::Format::Unknown, 0, pixelData, 0}, {{0, 0}, mapData}};
}

template <typename T, typename R>
constexpr auto createImageData(std::vector<T> &&pixels, Color::Format format, std::vector<R> &&colormap) -> Data
{
    return {0, "", DataType(), {{0, 0}, Color::Format::Unknown, Color::Format::Unknown, 0, ImageData{pixels, format, colormap}, 0}, {{0, 0}, {}}};
}

constexpr auto createMapData(MapData &&mapData) -> Data
{
...
TEST_CASE("combineRawPixelData")
{
    ...
    Data d0 = createData(std::vector<Color::XRGB8888>({0x00112233, 0x00445566}), {});
    Data d1 = createData(std::vector<Color::XRGB8888>({0x00778899, 0x00AABBCC}), {});
    ...
    Data d2 = createData(std::vector<Color::XRGB8888>({0x00112233}), {});
    Data d3 = createData(std::vector<Color::XRGB8888>({0x00AABBCC, 0x00DDEEFF}), {});
    ...
    Data d4 = createData(std::vector<Color::XRGB1555>({0x0011}), {});
    Data d5 = createData(std::vector<Color::XRGB1555>({0x00AA, 0x00DD}), {});
...
TEST_CASE("combineRawPixelDataInterleave")
{
    ...
    CATCH_REQUIRE(r0.first.empty());
    CATCH_REQUIRE(r0.second.empty());
    Data d0 = createData(std::vector<Color::XRGB1555>({0x0011, 0x0044}), {});
    Data d1 = createData(std::vector<Color::XRGB1555>({0x0077, 0x00AA}), {});
    std::vector<Data> v1 = {d0, d1};
...
TEST_CASE("combineRawMapData")
{
    ...
    CATCH_REQUIRE(r0.first.empty());
    CATCH_REQUIRE(r0.second.empty());
    Data d0 = createMapData(std::vector<uint16_t>({0x1122, 0x3344}));
    Data d1 = createMapData(std::vector<uint16_t>({0x5566, 0x7788}));
    std::vector<Data> v1 = {d0, d1};
    ...
    Data d2 = createMapData(std::vector<uint16_t>({0x1122}));
...
TEST_CASE("combineRawColorMapData")
{
    ...
    CATCH_REQUIRE(r0.first.empty());
    CATCH_REQUIRE(r0.second.empty());
    Data d0 = createImageData(std::vector<uint8_t>({0x00, 0x01}), Color::Format::Paletted8, std::vector<Color::XRGB8888>({0x00112233, 0x00445566}));
    Data d1 = createImageData(std::vector<uint8_t>({0x00, 0x01}), Color::Format::Paletted8, std::vector<Color::XRGB8888>({0x00778899, 0x00AABBCC}));
    std::vector<Data> v1 = {d0, d1};
    ...
    CATCH_REQUIRE(r3.second.size() == 2);
    CATCH_REQUIRE(r3.second == std::vector<uint32_t>({0, 2}));
    Data d2 = createImageData(std::vector<uint8_t>({0x00, 0x01}), Color::Format::Paletted8, std::vector<Color::XRGB8888>({0x00112233}));
    Data d3 = createImageData(std::vector<uint8_t>({0x00, 0x01}), Color::Format::Paletted8, std::vector<Color::XRGB8888>({0x00AABBCC, 0x00DDEEFF}));
    std::vector<Data> v2 = {d2, d3};
    ...
    CATCH_REQUIRE(r4.second.size() == 2);
    CATCH_REQUIRE(r4.second == std::vector<uint32_t>({0, 1}));
    Data d4 = createImageData(std::vector<uint8_t>({0x00, 0x01}), Color::Format::Paletted8, std::vector<Color::XRGB1555>({0x0011}));
    Data d5 = createImageData(std::vector<uint8_t>({0x00, 0x01}), Color::Format::Paletted8, std::vector<Color::XRGB1555>({0x00AA, 0x00DD}));
    std::vector<Data> v3 = {d4, d5};
