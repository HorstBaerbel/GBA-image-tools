...
DecodeBlock4x4:
    ...
    ands r5, r4, #DXTV_CONSTANTS_BLOCK_IS_REF @ check if block is a motion compensated or DXT block
    beq .db4x4_dxt
.db4x4_mc:
    // ----- copy motion compensated block -----
    ands r5, r4, #DXTV_CONSTANTS_BLOCK_FROM_PREV @ check if block is from the previous frame
